            ...
            <div class="row">
              <div class="col-md-6 gx-5 mb-4">
                ...
                <div class="bg-image hover-overlay">
                  <img src="./img/Playground.JPG" class="w-100" />
                  <div
                    class="mask"
                    style="
              ...
              <div class="col-md-6 gx-5 mb-4">
                ...
                <div class="" style="font-size: large;">
                  <p>Our garden facility is a stunning outdoor venue that offers a serene and picturesque setting for a range of events. <br> 
                    ...
                    Our team of professionals provides a range of services to ensure that your event runs smoothly, from event planning and catering to on-site management. </p>
                </div>
              </div>
            </div>
          </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/garden2.JPG" class="img-fluid" />
                <a href="" target="">
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/garden3.JPG" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/tent.JPG" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/garden7.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/garden8.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/garden9.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
...
<!-- 
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/garden10.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
...
<!-- 
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/garden11.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
