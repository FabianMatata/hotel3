          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="./accommodation.php" target="_blank" class="btn btn-3" style="background-color: #fea116; color: black; font-size: large;">See Details</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="./gardens.php" target="_blank" class="btn btn-3" style="background-color: #fea116; color: black; font-size: large;">See Details</a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="container text-center text-md-start mt-5">
              ...
              <div class="row mt-3">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                  ...
                  <p>
                    <a href="./conference.php" target="_blank" class="text-reset">Conference Facilities</a>
                  </p>
                  <p>
