...
<body>
    ...
    <section id="intro">
        ...
        <!--carousel start-->
        <!-- Carousel wrapper -->
        <div id="carouselMaterialStyle" class="carousel slide carousel-fade" data-mdb-ride="carousel" style="" id="">
            <!-- Indicators -->
            ...
            <div class="carousel-inner rounded-5 shadow-4-strong">
                ...
                <div class="carousel-item active">
                    <img src="./img/waterfall6.jpg" class="d-block w-100 " alt="" />
                ...
                <div class="carousel-item">
                    <img src="./img/lagat.JPG" class="d-block w-100" alt="" />
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                ...
                <!-- Single item -->
                <div class="carousel-item">
                    <img src="./img/seats.JPG" class="d-block w-100" alt="" />
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
            </div>
    ...
    <main class="mt-5">
        <div class="">
            <section class="text-center px-2" id="facilities">
            ...
            <!--amenities-->
            <section class="mt-5" id="amenities">
                <div class="text-center">
                    <h4 class="mb-5 text-center"><strong>Our <span style="color: #fea116;">Amenities</span></strong>
                    </h4>
                </div>
                ...
                <div>
                    <div class="container text-center">
                        <div class="row">
                            ...
                            <div class="col">
                                <img src="./img/wifi.png" alt="" style="height: 50px; width: 50px" />
                            </div>
                            <div class="col">
                                <img src="./img/parking.png" alt="" style="height: 50px; width: 50px" />
                            </div>
                            <div class="col">
                                <img src="./img/disability.png" alt="" style="height: 50px; width: 50px" />
                            </div>
                            <div class="col">
                                <img src="./img/24-hour-service.png" alt="" style="height: 50px; width: 50px" />
                            </div>
                            <div class="col">
                                <img src="./img/safe-place-logo.webp" alt="" style="height: 50px; width: 50px" />
                            </div>
                            <div class="col"></div>
                            <div class="col"></div>
                        </div>
