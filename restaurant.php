            ...
            <div class="row">
              <div class="col-md-6 gx-5 mb-4">
                ...
                <div class="bg-image hover-overlay">
                  <img src="./img/res6.jpg" class="w-100" />
                  <div
                    class="mask"
                    style="
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/res.JPG" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/res2.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-12">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/res3.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/res4.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
          ...
          <div class="col-lg-4 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/res5.jpg" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/food2.JPG" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
          ...
          <div class="col-lg-4 mb-4 mb-lg-0 d-none d-lg-block">
            ...
            <div class="card">
              <div class="bg-image hover-overlay hover-zoom hover-shadow ripple" data-mdb-ripple-color="light">
                <img src="./img/food3.JPG" class="img-fluid" />
                <a href="" target="">
                  <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                </a>
              </div>
  ...
  <main class="mt-5">
    <div class="">
      ...
      <section class="mb-5" id="reservations">
        ...
        <p class="text-center">Please fill in the form below for reservations. <br>
