                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Modern decor, comfortable amenities, and attentive service for a relaxing solo retreat.
                            </p>
                            <ul>
                ...
                <div class="col-lg-4 col-md-6 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Twin bed room offers a comfortable and convenient retreat for travelers seeking separate
                                beds.</p>
                            <ul>
                                <li>bathroom & balcony</li>
                                <li>disability friendly</li>
                    ...
                    <div class="col-md-6">
                        <form action="https://formsubmit.co/ombevab@kise.ac.ke" target="_blank" method="POST">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="number" name="Phone Number" id="form3Example2"
                                            class="form-control" />
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="number" name="Number of PAX(Male)" id="" class="form-control"
                                            min="0" />
                                ...
                                <div class="col">
                                    <div class="form-outline">
                                        <input type="number" name="Number of PAX(Female)" id="" class="form-control"
                                            min="0" />
                            ...
                            <div class="form-outline mb-4">
                                <textarea class="form-control" name="Additional Information" id="textAreaExample"
                                    rows="4"></textarea>
