                    ...
                    <div class="col-md-6 gx-5 mb-4">
                        ...
                        <div class="" style="font-size: large;">
                            <p>Our conference facility is a state-of-the-art venue designed to provide a professional
                                ...
                                versatile spaces that can accommodate groups of all sizes. <br>
                                Our experienced team provides comprehensive support to ensure that every detail is
                                covered, from event planning and catering to on-site management and technical support.
                                <br>
                                With a focus on comfort and convenience, our conference facility offers everything you
                                need to host a successful and engaging event, including ergonomic seating, high-speed
                                Wi-Fi, and advanced audiovisual equipment.
                            </p>
                        </div>
                    </div>
                </div>
   ...
   <!--                          <ul>
    ...
    <section class="pt-5" id="gallery">
        ...
        <div id="carouselMultiItemExample" class="carousel slide carousel-dark text-center" data-mdb-ride="carousel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 d-none d-lg-block">
                                ...
                                <div class="card">
                                    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple"
                                        data-mdb-ripple-color="light">
                                        <img src="./img/lagat3.JPG" class="img-fluid" />
                                        <a href="" target="">
                                            <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-4 d-none d-lg-block">
                                ...
                                <div class="card">
                                    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple"
                                        data-mdb-ripple-color="light">
                                        <img src="./img/conf.JPG" class="img-fluid" />
                                        <a href="" target="">
                                            <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                                        </a>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 d-none d-lg-block">
                                ...
                                <div class="card">
                                    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple"
                                        data-mdb-ripple-color="light">
                                        <img src="./img/lagat5.JPG" class="img-fluid" />
                                        <a href="" target="">
                                            <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-4 d-none d-lg-block">
                                ...
                                <div class="card">
                                    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple"
                                        data-mdb-ripple-color="light">
                                        <img src="./img/lagat6.JPG" class="img-fluid" />
                                        <a href="" target="">
                                            <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                                        </a>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                                ...
                                <div class="card">
                                    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple"
                                        data-mdb-ripple-color="light">
                                        <img src="./img/lagat7.JPG" class="img-fluid" />
                                        <a href="" target="">
                                            <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-4 mb-4 mb-lg-0 d-none d-lg-block">
                                ...
                                <div class="card">
                                    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple"
                                        data-mdb-ripple-color="light">
                                        <img src="./img/lagat8.JPG" class="img-fluid" />
                                        <a href="" target="">
                                            <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-4 mb-4 mb-lg-0 d-none d-lg-block">
                                ...
                                <div class="card">
                                    <div class="bg-image hover-overlay hover-zoom hover-shadow ripple"
                                        data-mdb-ripple-color="light">
                                        <img src="./img/lagat9.JPG" class="img-fluid" />
                                        <a href="" target="">
                                            <div class="mask" style="background-color: hsla(195, 83%, 58%, 0.2)"></div>
                                        </a>
                                    </div>
            ...
            <button class="carousel-control-prev" type="button" data-mdb-target="#carouselMultiItemExample"
                data-mdb-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-mdb-target="#carouselMultiItemExample"
                data-mdb-slide="next">
        ...
        <div class="">
            ...
            <footer class="text-center text-lg-start bg-light text-muted">
                ...
                <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom"
                    style="background-color: #fea116; color: white;">
                    <!-- Left -->
                    ...
                    <div class="container text-center text-md-start mt-5">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4" style="">
                                ...
                                <p>
                                    Experience luxurious comfort <br> and exceptional service in our <br> elegant and
                                    welcoming hotel.
                                </p>
                            </div>
                            <!-- Grid column -->
                ...
                <div class="text-center p-4" style="background-color: #303031; color: white;">
                    Copyright © 2023 :
                    <a class="text-reset fw-bold" href="#">ARC Hotel <span class="px-1">|</span> All Rights
                        Reserved.</a>
                </div>
                <!-- Copyright -->
            </footer>
